...
package uk.gov.hmrc.merchandiseinbaggageinternalfrontend.forms.behaviours

import org.scalatestplus.scalacheck.ScalaCheckPropertyChecks
import play.api.data.{Form, FormError}
import uk.gov.hmrc.merchandiseinbaggageinternalfrontend.forms.FormSpec
import uk.gov.hmrc.merchandiseinbaggageinternalfrontend.forms.mappings.LocalDateFormatter.{dayBlankErrorKey, monthBlankErrorKey, yearBlankErrorKey}
import uk.gov.hmrc.merchandiseinbaggageinternalfrontend.generators.Generators
