...
import uk.gov.hmrc.merchandiseinbaggageinternalfrontend.forms.GoodsDestinationForm.form
...
import uk.gov.hmrc.merchandiseinbaggageinternalfrontend.model.core.{GoodsDestination, GoodsDestinations}
