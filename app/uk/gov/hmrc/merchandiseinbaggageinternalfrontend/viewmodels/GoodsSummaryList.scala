...
package uk.gov.hmrc.merchandiseinbaggageinternalfrontend.viewmodels
...
import uk.gov.hmrc.merchandiseinbaggageinternalfrontend.model.core.{DeclarationGoods, DeclarationType, Goods}
